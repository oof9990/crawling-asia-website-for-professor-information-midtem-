the biggest obstacle i ran into is where to find the CSS selector(if your file comes up empty when operating the code this is most likely the problem),so here is a step-by-step way to find it 
